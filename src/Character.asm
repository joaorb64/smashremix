...
scope Character {
    ...
    // 0x4A - CLOUD
    define_character(CLOUD, LINK, File.CLOUD_MAIN, 0x0E0, 0, File.CLOUD_CHARACTER, 0x147, File.CLOUD_PROJECTILE_HITBOX, File.CLOUD_SLASH_GRAPHIC, File.CLOUD_SLASH_GRAPHIC, File.CLOUD_SLASH_GRAPHIC, 0x7EC, 10, OS.TRUE, OS.TRUE, Stages.id.BTT_LINK, Stages.id.BTP_LINK, Stages.id.BTT_YL, Stages.id.BTP_YL, sound_type.U, variant_type.NA)
