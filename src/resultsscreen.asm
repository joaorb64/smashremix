...
scope ResultsScreen {
    ...
    add_to_results_screen(Character.id.RYU,      FGM.announcer.names.MARIO,                  SMASH,           Character.id.CAPTAIN, 185,     RYU,          30,     1,          {MIDI.id.SF2_VICTORY})
    add_to_results_screen(Character.id.KEN,      FGM.announcer.names.LUIGI,                  SMASH,           Character.id.CAPTAIN, 185,     KEN,          30,     1,          {MIDI.id.SF2_VICTORY})
    add_to_results_screen(Character.id.CLOUD,    FGM.announcer.names.LINK,                   SMASH,           Character.id.LINK,    170,     CLOUD,          40,     1,         {MIDI.id.CLOUD_VICTORY})
    add_to_results_screen(Character.id.KAZUYA,   FGM.announcer.names.WARIO,                  SMASH,           Character.id.CAPTAIN, 180,     KAZUYA,          20,     0.9,      {MIDI.id.SF2_VICTORY})
