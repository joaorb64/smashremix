...
scope Ryu {
    ...
    Character.add_new_action(RYU,    DTILT_L,            -1,             ActionParams.DTILT_L,          -1,           RyuCancelItselfDtilt.main,      0,                                  0x800D8BB4,                     0x800DDF44)
    Character.add_new_action(RYU,    UTILT_L,            -1,             ActionParams.UTILT_L,          -1,           RyuCancelItselfUtilt.main,      0,                                  0x800D8BB4,                     0x800DDF44)
    ...
    AI.edit_attack_behavior(CPU_ATTACKS_ORIGIN, USPA,   -1,  6,   18,   89, 475, 0, 200)
    AI.edit_attack_behavior(CPU_ATTACKS_ORIGIN, USPG,   -1,  6,   18,   89, 475, 0, 200)
