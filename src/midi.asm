...
scope MIDI {
	...
	insert_midi(SSF2TKEN, OS.TRUE, OS.TRUE, "USA - Ken Stage (CPS2)", ssf2t)
	insert_midi(SNESGUILE, OS.TRUE, OS.TRUE, "USA - Guile Stage", sf2snes)
	...
	// Mod's 1st custom instrument yaaay
	...
	// Feel the distortion~
	add_instrument_sample(Distortion_Strat_D2, 0x0, 0x00300000, 66 * 350, 0x7F, 0x3F, 0x0, 0x7F, 0,  66,  63, 0x0, 0x3F, 0x7E, OS.TRUE, 31998, 32820, 0xFFFFFFFF, OS.FALSE)
    add_instrument_sample(Distortion_Strat_A2, 0x0, 0x00300000, 66 * 350, 0x7F, 0x3F, 0x0, 0x7F, 67, 70,  70, 0x0, 0x3F, 0x7E, OS.TRUE, 29918, 30466, 0xFFFFFFFF, OS.FALSE)
    add_instrument_sample(Distortion_Strat_C3, 0x0, 0x00300000, 66 * 350, 0x7F, 0x3F, 0x0, 0x7F, 71, 75,  72, 0x0, 0x3F, 0x7E, OS.TRUE, 35850, 44656, 0xFFFFFFFF, OS.FALSE)
    add_instrument_sample(Distortion_Strat_F3, 0x0, 0x00300000, 66 * 350, 0x7F, 0x3F, 0x0, 0x7F, 76, 81,  77, 0x0, 0x3F, 0x7E, OS.TRUE, 19592, 19957, 0xFFFFFFFF, OS.FALSE)
    add_instrument_sample(Distortion_Strat_C4, 0x0, 0x00300000, 66 * 350, 0x7F, 0x3F, 0x0, 0x7F, 82, 86,  84, 0x0, 0x3F, 0x7E, OS.TRUE, 27157, 27524, 0xFFFFFFFF, OS.FALSE)
    add_instrument_sample(Distortion_Strat_F4, 0x0, 0x00300000, 66 * 350, 0x7F, 0x3F, 0x0, 0x7F, 87, 91, 89, 0x0, 0x3F, 0x7E, OS.TRUE, 20152, 20335, 0xFFFFFFFF, OS.FALSE)
	add_instrument_sample(Distortion_Strat_C5, 0x0, 0x00300000, 66 * 350, 0x7F, 0x3F, 0x0, 0x7F, 92, 98,  96, 0x0, 0x3F, 0x7E, OS.TRUE, 14653, 14836, 0xFFFFFFFF, OS.FALSE)
    add_instrument_sample(Distortion_Strat_F5, 0x0, 0x00300000, 66 * 350, 0x7F, 0x3F, 0x0, 0x7F, 99, 103, 101, 0x0, 0x3F, 0x7E, OS.TRUE, 24011, 24148, 0xFFFFFFFF, OS.FALSE)
	add_instrument_sample(Distortion_Strat_C6, 0x0, 0x00300000, 66 * 350, 0x7F, 0x3F, 0x0, 0x7F, 104, 127,  108, 0x0, 0x3F, 0x7E, OS.TRUE, 11859, 28593, 0xFFFFFFFF, OS.FALSE)
    add_instrument(Distortion Strat, 0x7E, 0x3F, 0x05, 0x04DD, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0)
	
	// A more compressed piano
	add_instrument_sample(Trinity_Grand_D2, 0x0, 0x0, 66 * 1879, 0x7F, 0x7F, 0x0, 0x7F, 0,  63,  62, 0x0, 0x3F, 0x7E, OS.TRUE, 34414, 60130, 0xFFFFFFFF, OS.FALSE)
    add_instrument_sample(Trinity_Grand_F2, 0x0, 0x0, 66 * 1879, 0x7F, 0x7F, 0x0, 0x7F, 64, 67,  66, 0x0, 0x3F, 0x7E, OS.TRUE, 33050, 50587, 0xFFFFFFFF, OS.FALSE)
    add_instrument_sample(Trinity_Grand_C3, 0x0, 0x0, 66 * 1879, 0x7F, 0x7F, 0x0, 0x7F, 68, 74, 72, 0x0, 0x3F, 0x7E, OS.TRUE, 31664, 51980, 0xFFFFFFFF, OS.FALSE)
	add_instrument_sample(Trinity_Grand_D3, 0x0, 0x0, 66 * 1879, 0x7F, 0x7F, 0x0, 0x7F, 75, 78, 75, 0x0, 0x3F, 0x7E, OS.TRUE, 34755, 54994, 0xFFFFFFFF, OS.FALSE)
    add_instrument_sample(Trinity_Grand_A3, 0x0, 0x0, 66 * 1879, 0x7F, 0x7F, 0x0, 0x7F, 79, 83, 81, 0x0, 0x3F, 0x7E, OS.TRUE, 25762, 40143, 0xFFFFFFFF, OS.FALSE)
	add_instrument_sample(Trinity_Grand_C4, 0x0, 0x0, 66 * 1879, 0x7F, 0x7F, 0x0, 0x7F, 84, 87, 85, 0x0, 0x3F, 0x7E, OS.TRUE, 34334, 50171, 0xFFFFFFFF, OS.FALSE)
	add_instrument_sample(Trinity_Grand_F4, 0x0, 0x0, 66 * 1879, 0x7F, 0x7F, 0x0, 0x7F, 88, 92, 89, 0x0, 0x3F, 0x7E, OS.TRUE, 18017, 35411, 0xFFFFFFFF, OS.FALSE)
    add_instrument_sample(Trinity_Grand_A4, 0x0, 0x0, 66 * 1879, 0x7F, 0x7F, 0x0, 0x7F, 93, 127, 94, 0x0, 0x3F, 0x7E, OS.TRUE, 16003, 36057, 0xFFFFFFFF, OS.FALSE)
	add_instrument(Trinity Grand, 0x7E, 0x3F, 0x05, 0x04DD, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0)
    ...
    add_instrument(Enigma Flute, 0x7E, 0x3F, 0x05, 0x04DD, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0)
	
	// Not a Flute (TM)
	add_instrument_sample(JV1080_Shaku_F4, 0x0, 0x0, 66 * 3500, 0x7F, 0x7F, 0x0, 0x7F, 0,  84,  77, 0x0, 0x3F, 0x7E, OS.TRUE, 31998, 32820, 0xFFFFFFFF, OS.FALSE)
    add_instrument_sample(JV1080_Shaku_C6, 0x0, 0x0, 66 * 3500, 0x7F, 0x7F, 0x0, 0x7F, 85, 127,  96, 0x0, 0x3F, 0x7E, OS.TRUE, 29918, 30466, 0xFFFFFFFF, OS.FALSE)
    add_instrument(Shakuhachi, 0x7E, 0x3F, 0x05, 0x04DD, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0)
